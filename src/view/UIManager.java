...
public class UIManager extends JPanel{
    ...
    private void drawVictoryScreen(Graphics2D g2) {
		...
		g2.fillRect(0,0, 1268, 708);

        g2.setFont(gameFont.deriveFont(50f));
        g2.setColor(Color.WHITE);
        String displayedStr = "YOU WON!";
        int stringLength = g2.getFontMetrics().stringWidth(displayedStr);
        g2.drawString(displayedStr, (getWidth()-stringLength)/2, getHeight()/3);
        String escapeMessage = "press Escape to Leave";
        int messageLength = g2.getFontMetrics().stringWidth(escapeMessage);
        g2.drawString(escapeMessage, (getWidth()-messageLength)/2, getHeight()/2);
    }
